<x-jet.action-section>
    ...
    <x-slot. name="content">
        ...
        <div class="mt-3 max-jet.w-xl text-sm text-gray-600">
            <p>
        ...
        @if ($this->enabled)
            @if ($showingQrCode)
                <div class="mt-4 max-jet.w-xl text-sm text-gray-600">
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="grid gap-1 max-jet.w-xl mt-4 px-jet.4 py-4 font-mono text-sm bg-gray-100 rounded-lg">
