<div class="py-8 mt-5">
    ...
    <div class=" font-roboto tracking-wider grid gap-10 sm:pt-20 pt-0">
        <x-web.home.items.heading label="Billing Made Simple and Efficient" />
        ...
        <div class="grid md:grid-cols-4 grid-cols-1 w-10/12 mx-auto gap-6">
            ...
            <x-web.home.items.cover-card
                ...
                bg_color="bg-[#66C25F]">
                <x-web.home.icons.sales-purchase-cover />
            </x-web.home.items.cover-card>
            ...
            <x-web.home.items.cover-card
                ...
                bg_color="bg-[#FEBA35]"
            >
                <x-web.home.icons.pay-rec-cover />
            </x-web.home.items.cover-card>
