<div>
    ...
    <x-jet.dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-jet.input x-jet.ref="plaintextToken" type="text" readonly :value="$plainTextToken"
                class="mt-4 bg-gray-100 px-jet.4 py-2 rounded font-mono text-sm text-gray-500 w-full break-all"
